...
class AppLocale extends ChangeNotifier {
  ...
  static const Map<String, Map<String, String>> _translations = {
    'en': {
      ...
      'rabi': 'Rabi',
      'zaid': 'Zaid',
      'terms_privacy_title': 'Terms & Privacy',
      'terms_privacy_content': 'By using this app, you agree to follow our guidelines and policies regarding farm data and market usage.',
      'ok': 'OK',
      'phone_hint': 'Enter phone number',
      'get_otp': 'Get OTP',
      'agree_to': 'By continuing you agree to our ',
      'terms_privacy_link': 'Terms & Privacy',
      'agree_to_suffix': '',
      'accept_terms_error': 'Please accept the Terms & Privacy first',
      'or': 'OR',
      'continue_google': 'Continue with Google',
      'enter_otp': 'Enter OTP',
      'otp_sent': 'We have sent a 6-digit code to your phone number.',
    ...
    'kn': {
      ...
      'rabi': 'ಹಿಂಗಾರು',
      'zaid': 'ಬೇಸಿಗೆ',
      'terms_privacy_title': 'ನಿಯಮಗಳು ಮತ್ತು ಗೌಪ್ಯತೆ',
      'terms_privacy_content': 'ಈ ಅಪ್ಲಿಕೇಶನ್ ಬಳಸುವ ಮೂಲಕ, ಕೃಷಿ ಡೇಟಾ ಮತ್ತು ಮಾರುಕಟ್ಟೆ ಬಳಕೆಗೆ ಸಂಬಂಧಿಸಿದ ನಮ್ಮ ಮಾರ್ಗಸೂಚಿಗಳು ಮತ್ತು ನೀತಿಗಳನ್ನು ಅನುಸರಿಸಲು ನೀವು ಒಪ್ಪುತ್ತೀರಿ.',
      'ok': 'ಸರಿ',
      'phone_hint': 'ಫೋನ್ ಸಂಖ್ಯೆ ನಮೂದಿಸಿ',
      'get_otp': 'OTP ಪಡೆಯಿರಿ',
      'agree_to': 'ಮುಂದುವರಿಯುವ ಮೂಲಕ ನೀವು ನಮ್ಮ ',
      'terms_privacy_link': 'ನಿಯಮಗಳು ಮತ್ತು ಗೌಪ್ಯತೆಗೆ',
      'agree_to_suffix': ' ಒಪ್ಪುತ್ತೀರಿ',
      'accept_terms_error': 'ದಯವಿಟ್ಟು ಮೊದಲು ನಿಯಮಗಳು ಮತ್ತು ಗೌಪ್ಯತೆಯನ್ನು ಒಪ್ಪಿಕೊಳ್ಳಿ',
      'or': 'ಅಥವಾ',
      'continue_google': 'Google ಮೂಲಕ ಮುಂದುವರಿಯಿರಿ',
      'enter_otp': 'OTP ನಮೂದಿಸಿ',
      'otp_sent': 'ನಿಮ್ಮ ಫೋನ್ ಸಂಖ್ಯೆಗೆ ನಾವು 6-ಅಂಕಿಯ ಕೋಡ್ ಕಳುಹಿಸಿದ್ದೇವೆ.',
      'verify_login': 'ಪರಿಶೀಲಿಸಿ ಮತ್ತು ಲಾಗಿನ್ ಮಾಡಿ',
      'what_is_name': 'ನಿಮ್ಮ ಹೆಸರೇನು?',
